...
```yaml
- uses: nholuongut/paths-filter@v3
  id: changes
  with:
    filters: |
      src:
...
For more information, see [CHANGELOG](https://github.com/nholuongut/paths-filter/blob/master/CHANGELOG.md)
...
- [test-reporter](https://github.com/nholuongut/test-reporter) - Displays test results from popular testing frameworks directly in GitHub
